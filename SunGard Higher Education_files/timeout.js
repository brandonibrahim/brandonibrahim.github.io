...
function alertQueryCallback()
{
    ...
    if (alertXmlHttpRequest.readyState == 4)
    {
        if (alertXmlHttpRequest.status == 200)
        {
            ...
            {
                window.top.location.href = "https://forum.montevallo.edu/jsp/misc/timedout.jsp";
            }
            ...
            {
                window.top.location.href = "https://forum.montevallo.edu/cp/home/logout";
            }
...
function doXmlPoll()
{
    ...
    url = /*URL*/ "https://forum.montevallo.edu/cp/alert/as?getAlertMessage=true";
